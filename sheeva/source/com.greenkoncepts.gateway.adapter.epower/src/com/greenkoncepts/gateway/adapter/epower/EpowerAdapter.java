...
public class EpowerAdapter extends AModbusAdapter {
			...
			if (adapterSettings.size() > 0) {
				...
				if (_numDevices > 0) {
					...
					for (int i = 0; i < _numDevices; i++) {
						...
						dev = null;
						if (device_category.equals(DEVICE_EPOWER_ECM770)) {
							dev = new ECM770(device_category, Integer.parseInt(device_instanceid));
						}
