...
{
	public static final String KURA_CONFIG      = "gkapp.configuration";
	public static final String KURA_PROPS_FILE  = "gkapp.properties";
	public static final String KURA_CUSTOM_CONFIG      = "gkapp.custom.configuration";
	public static final String KURA_CUSTOM_PROPS_FILE  = "gkapp_custom.properties";
	...
	public static final String KEY_KURA_NAME                                = "gkapp.name";
	public static final String KEY_KURA_VERSION                             = "gkapp.version";
	public static final String KEY_DEVICE_NAME                             = "gkapp.device.name";
	public static final String KEY_PLATFORM                                = "gkapp.platform";
	public static final String KEY_MODEL_ID                                = "gkapp.model.id";
	public static final String KEY_MODEL_NAME                              = "gkapp.model.name";
	public static final String KEY_PART_NUMBER                             = "gkapp.partNumber";
	public static final String KEY_SERIAL_NUM                              = "gkapp.serialNumber";
	public static final String KEY_BIOS_VERSION                            = "gkapp.bios.version";
	public static final String KEY_FIRMWARE_VERSION                        = "gkapp.firmware.version";
	public static final String KEY_PRIMARY_NET_IFACE                       = "gkapp.primary.network.interface";
	public static final String KEY_KURA_HOME_DIR                            = "gkapp.home";
	public static final String KEY_KURA_PLUGINS_DIR                         = "gkapp.plugins";
	public static final String KEY_KURA_DATA_DIR                            = "gkapp.data";
	public static final String KEY_KURA_TMP_DIR                             = "gkapp.tmp";
	public static final String KEY_KURA_SNAPSHOTS_DIR                       = "gkapp.snapshots";
	public static final String KEY_KURA_SNAPSHOTS_COUNT                     = "gkapp.snapshots.count";
	public static final String KEY_KURA_HAVE_NET_ADMIN                      = "gkapp.have.net.admin";
	public static final String KEY_KURA_HAVE_WEB_INTER                      = "gkapp.have.web.inter";
	public static final String KEY_KURA_STYLE_DIR	                       = "gkapp.style.dir";
	public static final String KEY_KURA_WIFI_TOP_CHANNEL                    = "gkapp.wifi.top.channel";
    public static final String KEY_KURA_KEY_STORE_PWD                       = "gkapp.ssl.keyStorePassword";
    public static final String KEY_KURA_TRUST_STORE_PWD                     = "gkapp.ssl.trustStorePassword";
	 ...
	 * The release.xml file is stored in /etc/gkapp/ and has the format:
