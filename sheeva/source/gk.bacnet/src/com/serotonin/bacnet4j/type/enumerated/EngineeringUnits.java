...
public class EngineeringUnits extends Enumerated {
	...
	public static EngineeringUnits toEngineeringUnits(String units) {
		if ("meters per second per second".equals(units)) {
			return metersPerSecondPerSecond;
		}

		if ("square meters".equals(units)) {
			return squareMeters;
		}
		if ("square centimeters".equals(units)) {
			return squareCentimeters;
		}

		if ("square feet".equals(units)) {
			return squareFeet;
		}
		if ("square inches".equals(units)) {
			return squareInches;
		}
		if ("currency 1".equals(units)) {
			return currency1;
		}

		if ("currency 2".equals(units)) {
			return currency2;
		}

		if ("currency 3".equals(units)) {
			return currency3;
		}

		if ("currency 4".equals(units)) {
			return currency4;
		}

		if ("currency 5".equals(units)) {
			return currency5;
		}

		if ("currency 6".equals(units)) {
			return currency6;
		}

		if ("currency 7".equals(units)) {
			return currency7;
		}

		if ("currency 8".equals(units)) {
			return currency8;
		}

		if ("currency 9".equals(units)) {
			return currency9;
		}

		if ("currency 10".equals(units)) {
			return currency10;
		}

		if ("milliamperes".equals(units)) {
			return milliamperes;
		}

		if ("amperes".equals(units)) {
			return amperes;
		}

		if ("amperes per meter".equals(units)) {
			return amperesPerMeter;
		}

		if ("amperes per square meter".equals(units)) {
			return amperesPerSquareMeter;
		}

		if ("ampere square meters".equals(units)) {
			return ampereSquareMeters;
		}

		if ("farads".equals(units)) {
			return farads;
		}

		if ("henrys".equals(units)) {
			return henrys;
		}

		if ("ohms".equals(units)) {
			return ohms;
		}

		if ("ohm meters".equals(units)) {
			return ohmMeters;
		}

		if ("milliohms".equals(units)) {
			return milliohms;
		}

		if ("kilohms".equals(units)) {
			return kilohms;
		}

		if ("megohms".equals(units)) {
			return megohms;
		}

		if ("siemens".equals(units)) {
			return siemens;
		}

		if ("siemens per meter".equals(units)) {
			return siemensPerMeter;
		}

		if ("teslas".equals(units)) {
			return teslas;
		}

		if ("volts".equals(units)) {
			return volts;
		}

		if ("millivolts".equals(units)) {
			return millivolts;
		}

		if ("kilovolts".equals(units)) {
			return kilovolts;
		}

		if ("megavolts".equals(units)) {
			return megavolts;
		}

		if ("volt amperes".equals(units)) {
			return voltAmperes;
		}

		if ("kilovolt amperes".equals(units)) {
			return kilovoltAmperes;
		}

		if ("megavolt amperes".equals(units)) {
			return megavoltAmperes;
		}

		if ("volt amperes reactive".equals(units)) {
			return voltAmperesReactive;
		}

		if ("kilovolt amperes reactive".equals(units)) {
			return kilovoltAmperesReactive;
		}

		if ("megavolt amperes reactive".equals(units)) {
			return megavoltAmperesReactive;
		}

		if ("volts per degree kelvin".equals(units)) {
			return voltsPerDegreeKelvin;
		}

		if ("volts per meter".equals(units)) {
			return voltsPerMeter;
		}

		if ("degrees phase".equals(units)) {
			return degreesPhase;
		}

		if ("power factor".equals(units)) {
			return powerFactor;
		}

		if ("webers".equals(units)) {
			return webers;
		}

		if ("joules".equals(units)) {
			return joules;
		}

		if ("kilojoules".equals(units)) {
			return kilojoules;
		}

		if ("kilojoules per kilogram".equals(units)) {
			return kilojoulesPerKilogram;
		}

		if ("megajoules".equals(units)) {
			return megajoules;
		}

		if ("watt hours".equals(units)) {
			return wattHours;
		}

		if ("kilowatt hours".equals(units)) {
			return kilowattHours;
		}

		if ("megawatt hours".equals(units)) {
			return megawattHours;
		}

		if ("btus".equals(units)) {
			return btus;
		}

		if ("kilo btus".equals(units)) {
			return kiloBtus;
		}

		if ("mega btus".equals(units)) {
			return megaBtus;
		}

		if ("therms".equals(units)) {
			return therms;
		}

		if ("ton hours".equals(units)) {
			return tonHours;
		}

		if ("joules per kilogram dry air".equals(units)) {
			return joulesPerKilogramDryAir;
		}

		if ("kilojoules per kilogram dry air".equals(units)) {
			return kilojoulesPerKilogramDryAir;
		}

		if ("megajoules per kilogram dry air".equals(units)) {
			return megajoulesPerKilogramDryAir;
		}

		if ("btus per pound dry air".equals(units)) {
			return btusPerPoundDryAir;
		}

		if ("btus per pound".equals(units)) {
			return btusPerPound;
		}

		if ("joules per degree kelvin".equals(units)) {
			return joulesPerDegreeKelvin;
		}

		if ("kilojoules per degree kelvin".equals(units)) {
			return kilojoulesPerDegreeKelvin;
		}

		if ("megajoules per degree kelvin".equals(units)) {
			return megajoulesPerDegreeKelvin;
		}

		if ("joules per kilogram degree kelvin".equals(units)) {
			return joulesPerKilogramDegreeKelvin;
		}

		if ("newton".equals(units)) {
			return newton;
		}

		if ("cycles per hour".equals(units)) {
			return cyclesPerHour;
		}

		if ("cycles per minute".equals(units)) {
			return cyclesPerMinute;
		}

		if ("hertz".equals(units)) {
			return hertz;
		}

		if ("kilohertz".equals(units)) {
			return kilohertz;
		}

		if ("megahertz".equals(units)) {
			return megahertz;
		}

		if ("per hour".equals(units)) {
			return perHour;
		}

		if ("grams of water per kilogram dry air".equals(units)) {
			return gramsOfWaterPerKilogramDryAir;
		}

		if ("percent relative humidity".equals(units)) {
			return percentRelativeHumidity;
		}

		if ("millimeters".equals(units)) {
			return millimeters;
		}

		if ("centimeters".equals(units)) {
			return centimeters;
		}
		...
		if ("candelas".equals(units)) {
			return candelas;
		}

		if ("candelas per square meter".equals(units)) {
			return candelasPerSquareMeter;
		}

		if ("watts per square foot".equals(units)) {
			return wattsPerSquareFoot;
		}

		if ("watts per square meter".equals(units)) {
			return wattsPerSquareMeter;
		}

		if ("lumens".equals(units)) {
			return lumens;
		}

		if ("luxes".equals(units)) {
			return luxes;
		}

		if ("foot candles".equals(units)) {
			return footCandles;
		}
		...
		if ("pounds mass".equals(units)) {
			return poundsMass;
		}

		if ("tons".equals(units)) {
			return tons;
		}

		if ("grams per second".equals(units)) {
			return gramsPerSecond;
		}

		if ("grams per minute".equals(units)) {
			return gramsPerMinute;
		}

		if ("kilograms per second".equals(units)) {
			return kilogramsPerSecond;
		}

		if ("kilograms per minute".equals(units)) {
			return kilogramsPerMinute;
		}

		if ("kilograms per hour".equals(units)) {
			return kilogramsPerHour;
		}

		if ("pounds mass per second".equals(units)) {
			return poundsMassPerSecond;
		}

		if ("pounds mass per minute".equals(units)) {
			return poundsMassPerMinute;
		}

		if ("pounds mass per hour".equals(units)) {
			return poundsMassPerHour;
		}

		if ("tons per hour".equals(units)) {
			return tonsPerHour;
		}

		if ("milliwatts".equals(units)) {
			return milliwatts;
		}

		if ("watts".equals(units)) {
			return watts;
		}

		if ("kilowatts".equals(units)) {
			return kilowatts;
		}

		if ("megawatts".equals(units)) {
			return megawatts;
		}

		if ("btus per hour".equals(units)) {
			return btusPerHour;
		}

		if ("kilo btus per hour".equals(units)) {
			return kiloBtusPerHour;
		}

		if ("horsepower".equals(units)) {
			return horsepower;
		}

		if ("tons refrigeration".equals(units)) {
			return tonsRefrigeration;
		}

		if ("pascals".equals(units)) {
			return pascals;
		}

		if ("hectopascals".equals(units)) {
			return hectopascals;
		}

		if ("kilopascals".equals(units)) {
			return kilopascals;
		}

		if ("millibars".equals(units)) {
			return millibars;
		}

		if ("bars".equals(units)) {
			return bars;
		}

		if ("pounds force per square inch".equals(units)) {
			return poundsForcePerSquareInch;
		}

		if ("centimeters of water".equals(units)) {
			return centimetersOfWater;
		}

		if ("inches of water".equals(units)) {
			return inchesOfWater;
		}

		if ("millimeters of mercury".equals(units)) {
			return millimetersOfMercury;
		}

		if ("centimeters of mercury".equals(units)) {
			return centimetersOfMercury;
		}

		if ("inches of mercury".equals(units)) {
			return inchesOfMercury;
		}

		if ("degrees celsius".equals(units)) {
			return degreesCelsius;
		}

		if ("degrees kelvin".equals(units)) {
			return degreesKelvin;
		}

		if ("degrees kelvin per hour".equals(units)) {
			return degreesKelvinPerHour;
		}

		if ("degrees kelvin per minute".equals(units)) {
			return degreesKelvinPerMinute;
		}

		if ("degrees fahrenheit".equals(units)) {
			return degreesFahrenheit;
		}

		if ("degree days celsius".equals(units)) {
			return degreeDaysCelsius;
		}

		if ("degree days fahrenheit".equals(units)) {
			return degreeDaysFahrenheit;
		}

		if ("delta degrees fahrenheit".equals(units)) {
			return deltaDegreesFahrenheit;
		}

		if ("delta degrees kelvin".equals(units)) {
		...
		if ("months".equals(units)) {
			return months;
		}

		if ("weeks".equals(units)) {
			return weeks;
		}
		...
		if ("hundredths seconds".equals(units)) {
		...
		if ("newton meters".equals(units)) {
			return newtonMeters;
		}

		if ("millimeters per second".equals(units)) {
			return millimetersPerSecond;
		}

		if ("millimeters per minute".equals(units)) {
			return millimetersPerMinute;
		}

		if ("meters per second".equals(units)) {
			return metersPerSecond;
		}

		if ("meters per minute".equals(units)) {
			return metersPerMinute;
		}

		if ("meters per hour".equals(units)) {
			return metersPerHour;
		}

		if ("kilometers per hour".equals(units)) {
			return kilometersPerHour;
		}

		if ("feet per second".equals(units)) {
			return feetPerSecond;
		}

		if ("feet per minute".equals(units)) {
			return feetPerMinute;
		}

		if ("miles per hour".equals(units)) {
			return milesPerHour;
		}

		if ("cubic feet".equals(units)) {
			return cubicFeet;
		}

		if ("cubic meters".equals(units)) {
			return cubicMeters;
		}

		if ("imperial gallons".equals(units)) {
			return imperialGallons;
		}
		if ("liters".equals(units)) {
			return liters;
		}
		if ("us gallons".equals(units)) {
			return usGallons;
		}
		if ("cubic feet per second".equals(units)) {
			return cubicFeetPerSecond;
		}
		if ("cubic feet per minute".equals(units)) {
			return cubicFeetPerMinute;
		}
		if ("cubic meters per second".equals(units)) {
			return cubicMetersPerSecond;
		}
		if ("cubic meters per minute".equals(units)) {
			return cubicMetersPerMinute;
		}
		if ("cubic meters per hour".equals(units)) {
			return cubicMetersPerHour;
		}
		if ("imperial gallons per minute".equals(units)) {
			return imperialGallonsPerMinute;
		}
		if ("liters per second".equals(units)) {
			return litersPerSecond;
		}
		if ("liters per minute".equals(units)) {
			return litersPerMinute;
		}
		if ("liters per hour".equals(units)) {
			return litersPerHour;
		}
		if ("us gallons per minute".equals(units)) {
			return usGallonsPerMinute;
		}
		if ("degrees angular".equals(units)) {
			return degreesAngular;
		}
		if ("degrees celsius per hour".equals(units)) {
			return degreesCelsiusPerHour;
		}
		if ("degrees celsius per minute".equals(units)) {
			return degreesCelsiusPerMinute;
		}
		if ("degrees fahrenheit per hour".equals(units)) {
			return degreesFahrenheitPerHour;
		}
		if ("degrees fahrenheit per minute".equals(units)) {
			return degreesFahrenheitPerMinute;
		}
		if ("joule seconds".equals(units)) {
			return jouleSeconds;
		}
		if ("kilograms per cubic meter".equals(units)) {
			return kilogramsPerCubicMeter;
		}
		if ("kilowatt hours per square meter".equals(units)) {
			return kilowattHoursPerSquareMeter;
		}
		if ("kilowatt hours per square foot".equals(units)) {
			return kilowattHoursPerSquareFoot;
		}
		if ("megajoules per square meter".equals(units)) {
			return megajoulesPerSquareMeter;
		}
		if ("megajoules per square foot".equals(units)) {
			return megajoulesPerSquareFoot;
		}
		if ("".equals(units)) {
			return noUnits;
		}
		if ("newton seconds".equals(units)) {
			return newtonSeconds;
		}
		if ("newtons per meter".equals(units)) {
			return newtonsPerMeter;
		}
		if ("parts per million".equals(units)) {
			return partsPerMillion;
		}
		if ("parts per billion".equals(units)) {
			return partsPerBillion;
		}
		if ("percent".equals(units)) {
			return percent;
		}
		if ("percent obscuration per foot".equals(units)) {
			return percentObscurationPerFoot;
		}
		if ("percent obscuration per meter".equals(units)) {
			return percentObscurationPerMeter;
		}
		if ("percent per second".equals(units)) {
			return percentPerSecond;
		}
		if ("per minute".equals(units)) {
			return perMinute;
		}
		if ("per second".equals(units)) {
			return perSecond;
		}
		if ("psi per degree fahrenheit".equals(units)) {
			return psiPerDegreeFahrenheit;
		}
		if ("radians".equals(units)) {
			return radians;
		}
		if ("radians per second".equals(units)) {
			return radiansPerSecond;
		}
		if ("revolutions per minute".equals(units)) {
			return revolutionsPerMinute;
		}
		if ("square meters perNewton".equals(units)) {
			return squareMetersPerNewton;
		}
		if ("watts per meter per degree kelvin".equals(units)) {
			return wattsPerMeterPerDegreeKelvin;
		}
		if ("watts per square meter degree kelvin".equals(units)) {
