...
public class CharacterString extends Primitive {
		...
		try {
			switch (encoding) {
				...
				case Encodings.IBM_MS_DBCS:
					// String[] code_page = { "EUC-JP", "ISO-2022-JP", "Shift_JIS", "x-IBM33722", "x-IBM930", "x-IBM933", "x-IBM935", "x-IBM937",
					// "x-IBM939", "x-IBM942", "x-IBM943" };
					byte[] result = null;
					try {
    ...
    private void validateEncoding() throws BACnetErrorException {
    	if (encoding != Encodings.ANSI_X3_4 && encoding != Encodings.ISO_8859_1 && encoding != Encodings.ISO_10646_UCS_2 && encoding != Encodings.IBM_MS_DBCS)
