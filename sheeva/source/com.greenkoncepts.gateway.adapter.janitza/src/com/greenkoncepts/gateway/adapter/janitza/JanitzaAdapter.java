...
public class JanitzaAdapter extends AModbusAdapter {
			...
			if (adapterSettings.size() > 0) {
				...
				if (_numDevices > 0) {
					...
					for (int i = 0; i < _numDevices; i++) {
						...
						dev = null;
						if (device_category.equals(DEVICE_JANITZA_UMG96S)) {
							dev = new UMG96S(Integer.parseInt(device_instanceid), device_category);
						}
