...
public class GeAquatransAdapter extends AModbusAdapter {
			...
			if (adapterSettings.size() > 0) {
				...
				if (_numDevices > 0) {
					...
					for (int i = 0; i < _numDevices; i++) {
						...
						dev = null;
						if (device_category.equals(DEVICE_WATER_GEAQUATRANS_AT600)) {
							dev = new GeAquatransAT600(Integer.parseInt(device_instanceid), device_category);
						}
