...
public class DaikinAdapter extends AModbusAdapter {
			...
			if (adapterSettings.size() > 0) {
				...
				if (_numDevices > 0) {
					...
					for (int i = 0; i < _numDevices; i++) {
						...
						dev = null;
						if (device_category.equalsIgnoreCase(DEVICE_DAIKIN_MIRCOTECH2)) {
							dev = new MicroTechII(device_category, Integer.parseInt(device_instanceid));
						} 
						if (dev != null) {
