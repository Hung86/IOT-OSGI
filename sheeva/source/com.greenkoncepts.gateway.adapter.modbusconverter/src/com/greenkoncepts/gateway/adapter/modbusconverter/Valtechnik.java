...
public class Valtechnik extends ModbusConverterDevice{	
	public Valtechnik(int address, String category, HashMap<Integer, DataPoint> nodeTable) {
		super(category, address, nodeTable);
		
//		queryDataCmdList.add(ModbusUtil.constructCommand3((byte) address, 8, 2));
//		queryDataCmdList.add(ModbusUtil.constructCommand3((byte) address, 22, 2));
//		queryDataCmdList.add(ModbusUtil.constructCommand3((byte) address, 36, 2));
//		queryDataCmdList.add(ModbusUtil.constructCommand3((byte) address, 50, 2));
//		queryDataCmdList.add(ModbusUtil.constructCommand3((byte) address, 64, 2));
//		queryDataCmdList.add(ModbusUtil.constructCommand3((byte) address, 78, 2));
	}
