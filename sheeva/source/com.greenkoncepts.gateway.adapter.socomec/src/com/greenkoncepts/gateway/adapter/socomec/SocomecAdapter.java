...
public class SocomecAdapter extends AModbusAdapter {
			...
			if (adapterSettings.size() > 0) {
				...
				if (_numDevices > 0) {
					...
					for (int i = 0; i < _numDevices; i++) {
						...
						dev = null;
						if (device_category.equals(DEVICE_SOCOMEC_COUNTISE44)) {
							dev = new CountisE44(Integer.parseInt(device_instanceid), device_category);
						}
