...
public class EcosailSCPMS16_v1_0 extends EcosailDevice {

	final static int CHANNEL_NUM = 16;
	// ----- Device Configuration
	public static int MBREG_CONFIG_START = 49002;
	public static int MBREG_CONFIG_NUM = 2;
	public static int MBREG_FACTORY_RESET = 48999;
	public static int MBREG_SAVE_REBOOT = 49000;
	public static int posAddress = 0;
	public static int posBaudrate = 1;
	private int[] cfData = new int[MBREG_CONFIG_NUM];

	// ----- Device Data
	// for the boards bought before 2013
	public static int MBREG_DATA_START = 48028;
	public static int MBREG_DATA_NUM = 82;
	...
	private int offset1 = 2 * (48030 - 48028);
	private int offset2 = 2 * (48062 - 48028);
	private int offset3 = 2 * (48078 - 48028);
	private int offset4 = 2 * (48094 - 48028);

	public EcosailSCPMS16_v1_0(int addr, String category) {
		super(category, addr);
	...
	private boolean decodingData(int idx, byte[] data, int mode) {
		...
		if (mode == DATA_MODE) {
			for (int i = 0; i < CHANNEL_NUM; i++) {
				reading[i] = ModbusUtil.registersMEToInt(data, OFFSET_DATA + offset1 + 4 * i);
